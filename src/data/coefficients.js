...
export const defaultConfig = {
  ...
  charger: {
    ...
    pilesPer10kSqm: { 商场: 4, 酒店: 2, 办公: 2, 医院: 2, 高校: 2, 工业厂房: 2, 数据中心: 1 }, // 双枪桩台数/万㎡
  },
  ...
  roof: {
    ...
    // 多高层/塔楼约吻合——取值依据见下方 ROOF_RATIO_SOURCE
...
const CYCLES_SOURCE = `中国能源研究会储能专委会/储能头条 2025 上半年分时电价盘点（${CYCLES_AS_OF}统计窗口）：时段结构支持两充两放的 8 省（浙江/广东/江苏/湖北/湖南/吉林/江西/天津）取 2，其余按一充一放保守计（贵州二充窗口仅 1 小时、山东深谷段结构未获名单确认，均计 1）；口径适用于电网代理购电用户——2026-03 起《电力中长期市场基本规则》市场化交易用户不再执行固定分时电价；各省分时时段年内仍会调整，决策前需核当月文件`
...
export const coefficientSections = [
  ...
  },
  {
    scope: 'public',
    title: '充电桩配建参考',
    hint: '按建筑类型的双枪一体桩配建台数（台/万㎡，1 桩 2 枪 ≈ 覆盖 2 个充电车位），模块① 充电桩规模推导用',
