...
const ROOF_RATIO_SOURCE =
  '屋顶可用面积占建筑面积比例，工程口径演示假设值（扣除机房/水箱/女儿墙/检修通道后净可安装面积，低层大屋面商场高于高层办公/医院）；政策侧量级印证：国家能源局 2021 年整县屋顶分布式光伏试点申报条件（“5432”）要求学校、医院等公共建筑屋顶可安装比例不低于 40%——系申报目标口径而非设计参数，需屋面净面积核实'
...
const CHARGER_PILES_SOURCE =
  '配建底线为公开政策：大型公共建筑物充电设施或预留条件车位比例不低于 10%（国办发〔2015〕73 号《关于加快电动汽车充电基础设施建设的指导意见》及住建部相关通知），北京等地方标准已达 25%~40%；桩/万㎡数值按典型车位密度 × 配建比例折算，仍为演示假设值，需车位与流量确认'
