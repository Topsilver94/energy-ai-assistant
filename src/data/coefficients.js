...
export const defaultConfig = {
  ...
  cooling: {
    ...
    loadIndex: { 办公: 120, 商场: 200, 医院: 120, 酒店: 95, 高校: 100, 数据中心: 800, 工业厂房: 150 }, // W/㎡，设计估算区间中值，见 COOLING_INDEX_SOURCE
  },
...
const COOLING_INDEX_SOURCE =
  '设计冷负荷指标（W/㎡，按供冷面积口径）：民用建筑取《实用供热空调设计手册》冷负荷估算区间中值（办公 90~150、商场 150~250、医院 100~150、酒店 80~110、高校 80~150）；数据中心按 IT 密度 600~1500 取偏保守中值；工业厂房以工艺发热为主、面积指标法先天粗糙（舒适性约 100 / 一般空调厂房 150~250 / 洁净厂房 300~500），150 仅作方案阶段量级粗估，实际以工艺资料逐项计算为准（GB 50019-2015）；指标法仅用于方案阶段估算，施工图须逐时逐项计算'
