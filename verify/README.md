...
| 脚本 | 覆盖 |
|---|---|
| `m1.cjs` | 模块①：表单→组合总账→分项表→敏感性；数值与手算对照（广东 光伏2MW+储能1MWh ⇒ 投资820万/IRR 20.5%/回收4.7年/碳减排1405.9t）；规模为 0 的校验 toast |
| `m2.cjs` | 模块②：既有路径（对标/潜力/评级/3条措施/推荐列表/热力图）、一键填入 STEP1、新建路径（设计校核、不输出节能潜力） |
